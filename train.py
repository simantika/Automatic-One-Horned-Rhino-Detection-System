...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='rhino', help='renames results.txt to results_name.txt if supplied')
    parser.add_argument('--device', default='0', help='device id (i.e. 0 or 0,1 or cpu)')
    parser.add_argument('--adam', default=True, help='use adam optimizer') #action='store_true'
